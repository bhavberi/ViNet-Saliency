...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, proposals):
        ...
        x = x.view(x.size(0), x.size(1), x.size(2) // 2, 2, x.size(3), x.size(4))
    ...
    def forward(self, x, boxes):
        ...
        proposals = boxes
        #print(f"proposals:{len(proposals[0])} {proposals[0][0]}")
...
def interpolate_pos_embed_online(
    ...
    print("pos_tokens: ", pos_tokens.size())
    print("extra_tokens: ", extra_tokens.size())
